					...
					<ul class="nav pull-right">
						...
						<li class="dropdown hidden-phone">
							...
							<ul class="dropdown-menu messages">
                            	...
                            	<li>
                                    <a href="#">
										<span class="avatar"><img src="<?= base_url(); ?>assets/adminfiles/img/avatar.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Dennis Ji
										     </span>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<?= site_url('store_items/manage'); ?>"><i class="icon-tag"></i><span class="hidden-tablet"> Manage Items</span></a></li>	
						<li><a href="<?= site_url('store_categories/manage'); ?>"><i class="icon-align-justify"></i>
						<span class="hidden-tablet"> Manage Categories</span></a></li>	
						<li><a href="<?= site_url('store_accounts/manage'); ?>"><i class="icon-briefcase"></i><span class="hidden-tablet"> Accounts</span></a></li>	
						<li><a href="messages.html"><i class="icon-envelope"></i><span class="hidden-tablet"> Manage</span></a></li>
